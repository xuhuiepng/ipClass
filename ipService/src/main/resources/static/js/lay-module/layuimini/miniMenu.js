    ...
    var miniMenu = {
        ...
        listen: function () {
            ...
            $('body').on('click', '[data-menu]', function () {
                ...
                if('multi_module_0' === menuId){
                    $('#layuiminiHomeTabIframe').html('<iframe width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  src="/page/ipLocation.html"></iframe>');     
                }else if ('multi_module_1' === menuId){
                    $('#layuiminiHomeTabIframe').html('<iframe width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  src="/home.html"></iframe>');          
                }   
                // header
